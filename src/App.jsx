...
export default function RadiografiaApp() {
  ...
  const generarDiagnostico = async () => {
    ...
    try {
      // Llamada a la función serverless de Netlify (no directamente a Anthropic)
    ...
    >
      ...
      {paso === "bienvenida" && (
        ...
        >
          ...
          >
            En 5 preguntas estratégicas, descubrirás cuál es tu mayor activo de
            conocimiento y cuál es tu siguiente paso más claro para convertirlo en
          ...
          >
            No es un quiz genérico. Es un diagnóstico personalizado creado con
            inteligencia artificial — diseñado para que llegues a la masterclass
            con claridad, no con confusión.
          </p>
          ...
          >
            © Anita Paniagua · Academia EmprendeSer™ · Tus respuestas se usan
            únicamente para generar tu diagnóstico.
          </p>
        </div>
      )}
          ...
          >
            ...
            <textarea
              ...
              style={{
                ...
                border: `1.5px solid ${
                  respuestas[indice] ? COLORS.teal : COLORS.border
                }`,
                borderRadius: 10,
                outline: "none",
                resize: "vertical",
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 20 }}>
              ...
              <button
                onClick={siguiente}
                disabled={!respuestas[indice].trim()}
                style={{
                  flex: 2,
                  background: respuestas[indice].trim()
                    ? COLORS.teal
                    : COLORS.border,
                  color: respuestas[indice].trim()
                    ? COLORS.white
                    : COLORS.textMuted,
                  border: "none",
                  borderRadius: 10,
                  ...
                  fontFamily: "'Arial', sans-serif",
                  fontWeight: 600,
                  cursor: respuestas[indice].trim() ? "pointer" : "not-allowed",
                  letterSpacing: "0.02em",
                }}
              >
            ...
            {preguntas.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  background: i <= indice ? COLORS.teal : COLORS.border,
      ...
      {paso === "cargando" && (
        <div style={{ maxWidth: 480, width: "100%", textAlign: "center" }}>
          ...
          >
            Estamos generando tu diagnóstico estratégico personalizado. Esto
      ...
      {paso === "resultado" && diagnostico && (
        <div style={{ maxWidth: 640, width: "100%" }}>
          <div
            style={{
              background: `linear-gradient(135deg, ${COLORS.teal} 0%, ${COLORS.tealMid} 100%)`,
